        ...
        <nav className="bg-transparent dark:bg-red-900   w-full z-20 top-0 left-0 border-b border-red-200 dark:border-red-600">
            <div className="max-w-screen-2xl flex flex-wrap  items-center justify-between mx-auto p-4">
                <a href="website" className="flex items-center">
                    <img src='\image\solutions-community-logo.png' className='object-scale-down h-15 w-20 rounded-lg mt-10' height={10} alt='logo' />
                </a>
                <div className="flex md:order-2">
                    {
                        Details === null ?
                            <button type="button" className="text-red-900  hover:bg-red-900  hover:bg-white-200 focus:ring-4 focus:outline-none border-red-900 border-4 hover:text-white font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 mt-10 " onClick={changeRoute}>Get started</button> :
                            <UserProfile />
                    }
