...
const Home = () => {
  ...
  <div class="container px-5 py-10 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium title-font  text-gray-900">Ask. Connect. Share Knowledge.</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Your Questions, Answered. Community Driven.</p>
    </div>
